import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,a as e}from"./app-JabzxadU.js";const t={},l=e(`<h1 id="ansible安装docker" tabindex="-1"><a class="header-anchor" href="#ansible安装docker"><span>ansible安装docker</span></a></h1><h2 id="设置主机清单-vim-etc-ansible-hosts" tabindex="-1"><a class="header-anchor" href="#设置主机清单-vim-etc-ansible-hosts"><span>设置主机清单 <code>vim /etc/ansible/hosts</code></span></a></h2><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>[docker]
192.168.0.[8:10]
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>节点监控进度</p><p>tail -f /root/install-docker.log</p>`,35),i=[l];function p(c,o){return s(),a("div",null,i)}const d=n(t,[["render",p],["__file","ansible-docker.html.vue"]]);export{d as default};
