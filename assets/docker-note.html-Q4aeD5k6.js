import{_ as t}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as l,o,c,b as s,e as n,d as e,a as i}from"./app-JabzxadU.js";const r="/vtest/assets/true-image-20211025122421088-xDXqPpbd.png",d="/vtest/assets/true-image-20210716144517921-FOYBDvsB.png",p="/vtest/assets/true-image-20210716144319159-PAKt-MPw.png",u="/vtest/assets/true-image-20210716144339073-4ottDKGS.png",v="/vtest/assets/true-image-20210716144351814-_Mu3lhsm.png",m="/vtest/assets/true-image-20210716152647038-e8mOdo8j.png",k="/vtest/assets/true-test-uPDGsya6.png",b="/vtest/assets/true-image-20210716175146294-XXkS9Rmv.png",h="/vtest/assets/true-image-20210716175240487-b-ItITZm.png",g="/vtest/assets/true-image-20210716221821041-7tAFf5UL.png",f="/vtest/assets/true-image-20210716221950684-OrHE7n--.png",x="/vtest/assets/true-image-20210716222615232-b0NtZhwI.png",_={},y=i('<h1 id="centos7-docker使用" tabindex="-1"><a class="header-anchor" href="#centos7-docker使用"><span>Centos7 Docker使用</span></a></h1><h2 id="前导" tabindex="-1"><a class="header-anchor" href="#前导"><span>前导</span></a></h2><p>Docker 包括三个基本概念:</p><ul><li><strong>镜像（Image）</strong>：Docker 镜像（Image），就相当于是一个 root 文件系统。比如官方镜像 ubuntu:16.04 就包含了完整的一套 Ubuntu16.04 最小系统的 root 文件系统。</li><li><strong>容器（Container）</strong>：镜像（Image）和容器（Container）的关系，就像是面向对象程序设计中的类和实例一样，镜像是静态的定义，容器是镜像运行时的实体。容器可以被创建、启动、停止、删除、暂停等。</li><li><strong>仓库（Repository）</strong>：仓库可看成一个代码控制中心，用来保存镜像。</li></ul><table><thead><tr><th style="text-align:left;">Docker</th><th style="text-align:left;">面向对象</th></tr></thead><tbody><tr><td style="text-align:left;">镜像</td><td style="text-align:left;">类</td></tr><tr><td style="text-align:left;">容器</td><td style="text-align:left;">对象</td></tr></tbody></table>',5),q=s("thead",null,[s("tr",null,[s("th",{style:{"text-align":"left"}},"概念"),s("th",{style:{"text-align":"left"}},"说明")])],-1),E=s("tr",null,[s("td",{style:{"text-align":"left"}},"Docker 镜像(Images)"),s("td",{style:{"text-align":"left"}},"Docker 镜像是用于创建 Docker 容器的模板，比如 Ubuntu 系统。")],-1),A=s("tr",null,[s("td",{style:{"text-align":"left"}},"Docker 容器(Container)"),s("td",{style:{"text-align":"left"}},"容器是独立运行的一个或一组应用，是镜像运行时的实体。")],-1),R=s("td",{style:{"text-align":"left"}},"Docker 客户端(Client)",-1),O={style:{"text-align":"left"}},I={href:"https://docs.docker.com/develop/sdk/",target:"_blank",rel:"noopener noreferrer"},D=s("tr",null,[s("td",{style:{"text-align":"left"}},"Docker 主机(Host)"),s("td",{style:{"text-align":"left"}},"一个物理或者虚拟的机器用于执行 Docker 守护进程和容器。")],-1),N=s("tr",null,[s("td",{style:{"text-align":"left"}},"Docker Registry"),s("td",{style:{"text-align":"left"}},[n("Docker 仓库用来保存镜像，可以理解为代码控制中的代码仓库。一个 Registry 中可以包含多个仓库（Repository）；每个仓库可以包含多个标签（Tag）；每个标签对应一个镜像。通常，一个仓库会包含同一个软件不同版本的镜像，而标签就常用于对应该软件的各个版本。我们可以通过 "),s("strong",null,"<仓库名>:<标签>"),n(" 的格式来指定具体是这个软件哪个版本的镜像。如果不给出标签，将以 "),s("strong",null,"latest"),n(" 作为默认标签。")])],-1),T=s("tr",null,[s("td",{style:{"text-align":"left"}},"Docker Machine"),s("td",{style:{"text-align":"left"}},"Docker Machine是一个简化Docker安装的命令行工具，通过一个简单的命令行即可在相应的平台上安装Docker，比如VirtualBox、 Digital Ocean、Microsoft Azure。")],-1),j=s("hr",null,null,-1),C=s("h2",{id:"一、下载与安装",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#一、下载与安装"},[s("span",null,"一、下载与安装")])],-1),M={href:"https://docs.docker.com/engine/install/centos/#prerequisites",target:"_blank",rel:"noopener noreferrer"},S={href:"https://docs.docker.com/engine/install/",target:"_blank",rel:"noopener noreferrer"},P={href:"https://docs.docker.com/desktop/windows/install/",target:"_blank",rel:"noopener noreferrer"},w={href:"https://docs.docker.com/desktop/linux/install/debian/",target:"_blank",rel:"noopener noreferrer"},$=i(`<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>sudo apt-get -y install ./docker-desktop-4.8.1-amd64.deb
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="a、前提条件" tabindex="-1"><a class="header-anchor" href="#a、前提条件"><span>A、前提条件</span></a></h3><h4 id="_1、卸载旧版本" tabindex="-1"><a class="header-anchor" href="#_1、卸载旧版本"><span>1、卸载旧版本</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">sudo</span> yum remove <span class="token function">docker</span> docker-client docker-client-latest docker-common docker-latest docker-latest-logrotate docker-logrotate docker-engine 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="b、安装方法" tabindex="-1"><a class="header-anchor" href="#b、安装方法"><span>B、安装方法</span></a></h3><h4 id="_1、设置存储库《centos》" tabindex="-1"><a class="header-anchor" href="#_1、设置存储库《centos》"><span>1、设置存储库《centos》</span></a></h4><p>centos</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>---------华为--------------
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2、添加docker官方的gpg密钥" tabindex="-1"><a class="header-anchor" href="#_2、添加docker官方的gpg密钥"><span>2、添加Docker官方的GPG密钥</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>-----------------debian
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>设置 <strong>稳定</strong> 存储库</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>-----------------debian
...
<span class="token builtin class-name">echo</span> <span class="token punctuation">\\</span>
  ...
  <span class="token variable"><span class="token variable">$(</span>lsb_release <span class="token parameter variable">-cs</span><span class="token variable">)</span></span> stable&quot;</span> <span class="token operator">|</span> <span class="token function">sudo</span> <span class="token function">tee</span> /etc/apt/sources.list.d/docker.list <span class="token operator">&gt;</span> /dev/null
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>sudo apt-get update</p></blockquote><h4 id="_3、安装" tabindex="-1"><a class="header-anchor" href="#_3、安装"><span>3、安装</span></a></h4><p><em><strong>（1、2 选其一安装）</strong></em>*</p><p>1 <strong>默认最新版本</strong></p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">sudo</span> yum <span class="token parameter variable">-y</span> <span class="token function">install</span> docker-ce docker-ce-cli containerd.io
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2 <strong>指定版本</strong></p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">apt-cache</span> madison docker-ce
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a href="#%E5%8A%A0%E9%80%9F">设置镜像加速</a></p><p>1 <strong>启动Docker</strong></p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">sudo</span> systemctl start <span class="token function">docker</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+r+`" alt="image-20211025122421088" tabindex="0" loading="lazy"><figcaption>image-20211025122421088</figcaption></figure><h4 id="非root用户" tabindex="-1"><a class="header-anchor" href="#非root用户"><span>非root用户</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">usermod</span> <span class="token parameter variable">-aG</span> <span class="token function">docker</span> jf123 <span class="token comment">#非root用户</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>请记住注销并重新登录才能生效！</p><h3 id="c、卸载docker" tabindex="-1"><a class="header-anchor" href="#c、卸载docker"><span>C、卸载Docker</span></a></h3><p>卸载Docker Engine，CLI和Containerd软件包：</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">sudo</span> yum remove docker-ce docker-ce-cli containerd.io
<span class="token function">sudo</span> <span class="token function">apt-get</span> purge docker-ce docker-ce-cli containerd.io
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>主机上的映像，容器，卷或自定义配置文件不会自动删除。要删除所有图像，容器和卷：</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">rm</span> <span class="token parameter variable">-rf</span> /var/lib/docker
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>您必须手动删除所有已编辑的配置文件。</p><h2 id="二、docker-镜像加速" tabindex="-1"><a class="header-anchor" href="#二、docker-镜像加速"><span>二、Docker 镜像加速<a name="加速"></a></span></a></h2>`,35),F={href:"https://console.huaweicloud.com/swr/?region=cn-north-4#/app/swr/huaweiOfficialList",target:"_blank",rel:"noopener noreferrer"},V={href:"https://cr.console.aliyun.com/cn-hangzhou/instances/mirrors",target:"_blank",rel:"noopener noreferrer"},L=i(`<h3 id="_2、在-etc-docker配置daemon-json" tabindex="-1"><a class="header-anchor" href="#_2、在-etc-docker配置daemon-json"><span>2、在/etc/docker配置daemon.json</span></a></h3><p>基本</p><div class="language-json line-numbers-mode" data-ext="json" data-title="json"><pre class="language-json"><code>sudo mkdir -p /etc/docker
...
<span class="token punctuation">}</span>
EOF
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>k8s集群</p><div class="language-json line-numbers-mode" data-ext="json" data-title="json"><pre class="language-json"><code>sudo mkdir -p /etc/docker
...
EOF
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-json line-numbers-mode" data-ext="json" data-title="json"><pre class="language-json"><code><span class="token string">&quot;https://04eo9xup.mirror.aliyuncs.com&quot;</span><span class="token punctuation">,</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="启动服务" tabindex="-1"><a class="header-anchor" href="#启动服务"><span>启动服务</span></a></h1><p>sudo systemctl daemon-reload<br> sudo systemctl restart docker</p><h2 id="三、常用操作指令" tabindex="-1"><a class="header-anchor" href="#三、常用操作指令"><span>三、常用操作指令</span></a></h2><p>sudo vim ~/.bashrc</p><div class="language-BASH line-numbers-mode" data-ext="BASH" data-title="BASH"><pre class="language-BASH"><code>###some more ls aliases
alias rmf=&#39;rm -rf&#39;
alias ll=&#39;ls -l&#39;
alias la=&#39;ls -all&#39;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="镜像" tabindex="-1"><a class="header-anchor" href="#镜像"><span>--- 镜像 ---</span></a></h3><h4 id="_1、docker镜像检索" tabindex="-1"><a class="header-anchor" href="#_1、docker镜像检索"><span>1、docker镜像检索</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># docker search 镜像名</span>
<span class="token function">sudo</span> <span class="token function">docker</span> search centos
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2、docker镜像下载" tabindex="-1"><a class="header-anchor" href="#_2、docker镜像下载"><span>2、docker镜像下载</span></a></h4>`,15),U={href:"https://hub.docker.com/_/centos?tab=tags&page=1",target:"_blank",rel:"noopener noreferrer"},G=i(`<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># docker pull 镜像名</span>
<span class="token function">sudo</span> <span class="token function">docker</span> pull centos:centos7
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3、docker镜像列表" tabindex="-1"><a class="header-anchor" href="#_3、docker镜像列表"><span>3、docker镜像列表</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">docker</span> images
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><table><thead><tr><th>REPOSITORY</th><th>镜像的仓库源</th></tr></thead><tbody><tr><td>TAG</td><td>镜像的标签（版本）同一个仓库有多个TAG的镜像，多个版本；我们用REPOSITORY:TAG来定义不同的镜像；</td></tr><tr><td>IMAGE ID</td><td>镜像ID，镜像的唯一标识</td></tr><tr><td>CREATE</td><td>镜像创建时间</td></tr><tr><td>SIZE</td><td>镜像大小</td></tr></tbody></table><p><strong>OPTIONS 可选参数：</strong></p><table><thead><tr><th>-a</th><th>显示所有镜像（包括中间层）</th></tr></thead><tbody><tr><td>**-**q</td><td>只显示镜像ID</td></tr><tr><td>-qa</td><td>可以组合</td></tr><tr><td>--digests</td><td>显示镜像的摘要信息</td></tr><tr><td>--no-trunc</td><td>显示完整的镜像信息</td></tr></tbody></table><h4 id="_4、docker镜像删除" tabindex="-1"><a class="header-anchor" href="#_4、docker镜像删除"><span>4、docker镜像删除</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># docker rmi  image-id (镜像id)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_5、删除所有镜像" tabindex="-1"><a class="header-anchor" href="#_5、删除所有镜像"><span>5、删除所有镜像</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">docker</span> rmi  <span class="token variable"><span class="token variable">$(</span><span class="token function">docker</span> images <span class="token parameter variable">-q</span><span class="token variable">)</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="容器" tabindex="-1"><a class="header-anchor" href="#容器"><span>--- 容器 ---</span></a></h3><h4 id="指令" tabindex="-1"><a class="header-anchor" href="#指令"><span>指令</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token parameter variable">--name</span><span class="token operator">=</span><span class="token string">&quot;容器新名字&quot;</span>：为容器指定一个名称；
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2、容器列表" tabindex="-1"><a class="header-anchor" href="#_2、容器列表"><span>2、容器列表</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">docker</span> <span class="token function">ps</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3、启动容器" tabindex="-1"><a class="header-anchor" href="#_3、启动容器"><span>3、启动容器</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># docker start 容器名称/容器Id</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_4、停止容器" tabindex="-1"><a class="header-anchor" href="#_4、停止容器"><span>4、停止容器</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># docker  stop 容器名称/容器Id</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_5、删除容器" tabindex="-1"><a class="header-anchor" href="#_5、删除容器"><span>5、删除容器</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># docker rm 容器id</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_6、删除所有容器" tabindex="-1"><a class="header-anchor" href="#_6、删除所有容器"><span>6、删除所有容器</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">docker</span> <span class="token function">rm</span> <span class="token variable"><span class="token variable">$(</span><span class="token function">docker</span> <span class="token function">ps</span> <span class="token parameter variable">-a</span> <span class="token parameter variable">-q</span><span class="token variable">)</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="_7、容器日志" tabindex="-1"><a class="header-anchor" href="#_7、容器日志"><span>7、容器日志</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># docker logs 容器名称/容器id</span>
<span class="token function">sudo</span> <span class="token function">docker</span> logs webcentos
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_8、登陆、进入-退出容器" tabindex="-1"><a class="header-anchor" href="#_8、登陆、进入-退出容器"><span>8、登陆、进入\\退出容器</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># docker attach 容器名称/容器id</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>其中， -t 选项让Docker分配一个伪终端（ pseudo-tty）并绑定到容器的标准输入上， -i 则让容器的标准输入保持打开。</p><h4 id="_9、宿主机和容器之间文件拷贝" tabindex="-1"><a class="header-anchor" href="#_9、宿主机和容器之间文件拷贝"><span>9、宿主机和容器之间文件拷贝</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">#docker cp 容器名称：容器目录   宿主机目录</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_10、提交运行时容器成为镜像-commit" tabindex="-1"><a class="header-anchor" href="#_10、提交运行时容器成为镜像-commit"><span>10、提交运行时容器成为镜像 commit</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> commit <span class="token parameter variable">-a</span><span class="token operator">=</span><span class="token string">&#39;作者&#39;</span> <span class="token parameter variable">-m</span><span class="token operator">=</span><span class="token string">&#39;备注&#39;</span> 运行时容器ID 新镜像名称:<span class="token punctuation">[</span>版本<span class="token punctuation">]</span>
...
centos              centos7             b5b4d78bc90c        <span class="token number">2</span> weeks ago         203MB
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_11、推送镜像到hub服务器" tabindex="-1"><a class="header-anchor" href="#_11、推送镜像到hub服务器"><span>11、推送镜像到hub服务器</span></a></h4>`,35),B={href:"https://hub.docker.com/",target:"_blank",rel:"noopener noreferrer"},H={href:"https://hub.docker.com/",target:"_blank",rel:"noopener noreferrer"},z=s("h4",{id:"_12、推送镜像到阿里云-推荐",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#_12、推送镜像到阿里云-推荐"},[s("span",null,[n("12、推送镜像到阿里云<推荐>"),s("a",{name:"推送到阿里镜像仓库"})])])],-1),J={id:"a-阿里开通镜像服务",tabindex:"-1"},X={class:"header-anchor",href:"#a-阿里开通镜像服务"},Y={href:"https://cr.console.aliyun.com/",target:"_blank",rel:"noopener noreferrer"},K=i('<h5 id="b-创建命名空间-创建镜像仓库" tabindex="-1"><a class="header-anchor" href="#b-创建命名空间-创建镜像仓库"><span>b, 创建命名空间-创建镜像仓库</span></a></h5><figure><img src="'+d+'" alt="image-20210716144517921" tabindex="0" loading="lazy"><figcaption>image-20210716144517921</figcaption></figure><p>创建镜像仓库</p><figure><img src="'+p+'" alt="image-20210716144319159" tabindex="0" loading="lazy"><figcaption>image-20210716144319159</figcaption></figure><figure><img src="'+u+'" alt="image-20210716144339073" tabindex="0" loading="lazy"><figcaption>image-20210716144339073</figcaption></figure><figure><img src="'+v+`" alt="image-20210716144351814" tabindex="0" loading="lazy"><figcaption>image-20210716144351814</figcaption></figure><h5 id="c-登录阿里云docker-registry" tabindex="-1"><a class="header-anchor" href="#c-登录阿里云docker-registry"><span>c. 登录阿里云Docker Registry</span></a></h5><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> login <span class="token parameter variable">--username</span><span class="token operator">=</span>程序app registry.cn-chengdu.aliyuncs.com
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>用于登录的用户名为阿里云账号全名，密码为开通服务时设置的密码。</p><h5 id="d-从registry中拉取镜像" tabindex="-1"><a class="header-anchor" href="#d-从registry中拉取镜像"><span>d. 从Registry中拉取镜像</span></a></h5><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> pull registry.cn-chengdu.aliyuncs.com/0-test/nacos:<span class="token punctuation">[</span>镜像版本号<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h5 id="e-将镜像推送到registry" tabindex="-1"><a class="header-anchor" href="#e-将镜像推送到registry"><span>e. 将镜像推送到Registry</span></a></h5><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> login <span class="token parameter variable">--username</span><span class="token operator">=</span>小牛程序app registry.cn-chengdu.aliyuncs.com
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="g-示例" tabindex="-1"><a class="header-anchor" href="#g-示例"><span>g. 示例</span></a></h5><p>使用&quot;docker tag&quot;命令重命名镜像，并将它通过专有网络地址推送至Registry。</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>kong@k:~$ dkps
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+m+`" alt="image-20210716152647038" tabindex="0" loading="lazy"><figcaption>image-20210716152647038</figcaption></figure><h4 id="_13、查看容器元信息" tabindex="-1"><a class="header-anchor" href="#_13、查看容器元信息"><span>13、查看容器元信息</span></a></h4><p>docker inspect 容器ID</p><h4 id="_14、docker-update-修改容器配置" tabindex="-1"><a class="header-anchor" href="#_14、docker-update-修改容器配置"><span>14、docker update 修改容器配置</span></a></h4><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>Usage:  docker update [OPTIONS] CONTAINER [CONTAINER...]
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="四、容器目录挂载" tabindex="-1"><a class="header-anchor" href="#四、容器目录挂载"><span>四、容器目录挂载</span></a></h2><p>作用：</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>我们可以在创建容器的时候，将宿主机的目录与容器内的目录进行映射，这样我们就可以实现宿主机和容器目录的双向数据自动同步；
我们通过容器目录挂载，能够轻松实现代码上传，配置修改，日志同步等需求；
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>实现：</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>语法：
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>挂载目录只读：</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">-it</span> <span class="token parameter variable">-v</span>  /宿主机目录:/容器目录:ro 镜像名
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="五、dockerfile-构建镜像" tabindex="-1"><a class="header-anchor" href="#五、dockerfile-构建镜像"><span>五、DockerFile 构建镜像</span></a></h2><h3 id="常用指令" tabindex="-1"><a class="header-anchor" href="#常用指令"><span>常用指令</span></a></h3><ul><li><strong>FROM</strong> #定制的镜像都是基于 FROM 的镜像[<code>nginx，centos...</code>]</li><li><strong>RUN</strong> [&quot;可执行文件&quot;, &quot;参数1&quot;, &quot;参数2&quot;] #构建镜像时需要运行的[Linux、自定义]命令（可以写多条，建议使用 <strong>&amp;&amp;</strong> 连接符）；是在 docker build 时运行。</li></ul><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>RUN <span class="token punctuation">[</span><span class="token string">&quot;./test.jar&quot;</span>, <span class="token string">&quot;dev&quot;</span>, <span class="token string">&quot;offline&quot;</span><span class="token punctuation">]</span> 等价于RUN ./test.jar dev offline
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><strong>CMD</strong> #指定容器启动时要运行的命令，假如有多个CMD，最后一个生效；用于运行程序，在 docker run 时运行。CMD &lt;shell 命令&gt; ；</li></ul><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>CMD <span class="token punctuation">[</span><span class="token string">&quot;\\&lt;可执行文件或命令\\&gt;&quot;</span>,<span class="token string">&quot;\\&lt;param1&gt;&quot;</span>,<span class="token string">&quot;\\&lt;param2&gt;&quot;</span>,<span class="token punctuation">..</span>.<span class="token punctuation">]</span> 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><strong>MAINTAINER</strong> xxx #声明镜像维护者信息</li><li><strong>LABEL</strong> name=&quot;xxx&quot; \\ build-date=&quot;20201212&quot; #镜像描述元信息（可以写多条）</li><li><strong>WORKDIR</strong> /root/xx #设置终端默认登录进来的工作目录</li><li><strong>EXPOSE</strong> 8088 #当前容器对外暴露出的端口</li><li><strong>ADD</strong> 文件 容器内部目录 #将宿主机的文件复制到容器内，如果是一个压缩文件，将会在复制后<strong>自动解压</strong></li><li><strong>COPY</strong> [&quot;源文件&quot; &quot;容器内部路径&quot;] #和ADD相似，但是如果有压缩文件是<strong>不能解压</strong></li></ul><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>COPY home.txt /mydir/ <span class="token comment">#路径不存在的话，会自动创建。</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul><li><strong>VOLUME</strong> #创建一个可以从本地主机或其他容器挂载的挂载点，一般用来存放数据库和需要保持的数据等</li><li><strong>ENV</strong> &lt;key&gt;=&lt; value&gt;：为容器设置 Linux 环境变量 ，定义了环境变量，那么在后续的指令中，就可以使用这个环境变量。</li></ul><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>ENV JAVA_HOME /home/jdk1.8.0_151
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><strong>ARG</strong> &lt;key&gt;=&lt; value&gt;： 设置环境变量，环境变量只作用于Dockerfile内。</li><li><strong>ENTRYPOINT</strong> #指定容器启动时要运行的命令</li></ul><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>ENTRYPOINT <span class="token punctuation">[</span><span class="token string">&quot;\\&lt;executeable&gt;&quot;</span>,<span class="token string">&quot;\\&lt;param1&gt;&quot;</span>,<span class="token string">&quot;\\&lt;param2&gt;&quot;</span>,<span class="token punctuation">..</span>.<span class="token punctuation">]</span>
ENTRYPOINT nginx <span class="token parameter variable">-g</span> <span class="token string">&quot;daemon off;&quot;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><strong>USER</strong> 用于指定执行后续命令的用户和用户组 USER 用户名:用户组 <ul><li>USER kong:k</li></ul></li><li><strong>ONBUILD</strong> #当构建一个被继承的Dockerfile时运行的命令，父镜像在被子镜像继承后父镜像的onbuild被触发。可以把ONBUID理解为一个触发器。</li></ul><h3 id="dockerfile-示例" tabindex="-1"><a class="header-anchor" href="#dockerfile-示例"><span>DockerFile 示例</span></a></h3><h4 id="基于nginxdockerfile" tabindex="-1"><a class="header-anchor" href="#基于nginxdockerfile"><span>基于nginxDockerFile<a name="nginxDockerFile"></a></span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>FROM nginx
MAINTAINER kong9
ADD dist-vue.tar.gz /usr/share/nginx/html
ADD conf.tar.gz /etc/nginx
EXPOSE <span class="token number">80</span>
ENTRYPOINT nginx <span class="token parameter variable">-g</span> <span class="token string">&quot;daemon off;&quot;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="基于centosdockerfile" tabindex="-1"><a class="header-anchor" href="#基于centosdockerfile"><span>基于CentosDockerFile<a name="CentosDockerFile"></a></span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>FROM centos
MAINTAINER kong9
...
EXPOSE <span class="token number">80</span>
CMD /bin/bash
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="基于tomcatdockerfile" tabindex="-1"><a class="header-anchor" href="#基于tomcatdockerfile"><span>基于TomcatDockerFile<a name="基于TomcatDockerFile"></a></span></a></h4><p><strong>tomcat:9.0.62-jre8-temurin-focal、tomcat:8.5.78-jre8-temurin-focal</strong></p><p><strong>tomcat:9.0.62-jre11-temurin-focal、tomcat:8.5.78-jre11-temurin-focal</strong></p><p><strong>tomcat:9.0.62-jre17-temurin-focal、tomcat:8.5.78-jre17-temurin-focal</strong></p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">#使用的基础镜像</span>
FROM tomcat:8.5
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>FROM tomcat:9.0.62-jre11-temurin-focal
MAINTAINER kong9
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="基于centos7的java项目镜像" tabindex="-1"><a class="header-anchor" href="#基于centos7的java项目镜像"><span>基于centos7的java项目镜像<a name="基于centos7的java镜像"></a></span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>FROM registry.cn-chengdu.aliyuncs.com/jinfang/centos:7.9
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="基于jdk的java项目镜像-推荐" tabindex="-1"><a class="header-anchor" href="#基于jdk的java项目镜像-推荐"><span>基于jdk的java项目镜像&lt;推荐&gt;<a name="基于jdk的java镜像"></a></span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>
...
<span class="token comment">#ENTRYPOINT [&quot;java&quot;,&quot;-jar&quot;,&quot;/web-1.0.0.jar&quot;,&quot;--spring.profiles.active=prod&quot;]</span>
ENTRYPOINT <span class="token punctuation">[</span><span class="token string">&quot;/bin/bash&quot;</span>, <span class="token string">&quot;/run_module.sh&quot;</span><span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="dockerfile-构建java项目镜像" tabindex="-1"><a class="header-anchor" href="#dockerfile-构建java项目镜像"><span>DockerFile 构建java项目镜像</span></a></h3><h4 id="a-编写dockerfile文件" tabindex="-1"><a class="header-anchor" href="#a-编写dockerfile文件"><span>a, 编写DockerFile文件</span></a></h4><p><a href="#%E5%9F%BA%E4%BA%8Ejdk%E7%9A%84java%E9%95%9C%E5%83%8F"># 基于jdk的java镜像</a></p><h4 id="b-开始构建镜像" tabindex="-1"><a class="header-anchor" href="#b-开始构建镜像"><span>b, 开始构建镜像</span></a></h4><p>docker build -f [DockerFile文件] -t [设置标签]:版本 .</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> build <span class="token parameter variable">-f</span> myCentosDockerFile <span class="token parameter variable">-t</span> yu/mycentos:1.0 <span class="token builtin class-name">.</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>构建镜像OK后,推送到阿里镜像仓库 | docker hub镜像仓库</p><p><a href="#%E6%8E%A8%E9%80%81%E5%88%B0%E9%98%BF%E9%87%8C%E9%95%9C%E5%83%8F%E4%BB%93%E5%BA%93">#推送到阿里镜像仓库</a></p><h4 id="c-运行镜像" tabindex="-1"><a class="header-anchor" href="#c-运行镜像"><span>c, 运行镜像</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">-itd</span> 镜像ID <span class="token operator">||</span> <span class="token function">docker</span> run <span class="token parameter variable">-itd</span> <span class="token parameter variable">-p</span> <span class="token number">80</span>:8080 镜像ID
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="d-查看镜像历史" tabindex="-1"><a class="header-anchor" href="#d-查看镜像历史"><span>d, 查看镜像历史</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> <span class="token function">history</span> 镜像ID
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="六、docker-compose" tabindex="-1"><a class="header-anchor" href="#六、docker-compose"><span>六、Docker Compose</span></a></h2><h3 id="基础" tabindex="-1"><a class="header-anchor" href="#基础"><span>基础</span></a></h3><p>Compose 使用的三个步骤：</p><ul><li>使用 Dockerfile 定义应用程序的环境。</li><li>使用 docker-compose.yml 定义构成应用程序的服务，这样它们可以在隔离环境中一起运行。</li><li>最后，执行 docker-compose up 命令来启动并运行整个应用程序。</li></ul><p>docker-compose.yml 的配置案例如下:</p><div class="language-yaml line-numbers-mode" data-ext="yml" data-title="yml"><pre class="language-yaml"><code><span class="token comment"># yaml 配置实例</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ <span class="token function">sudo</span> <span class="token function">chmod</span> +x /usr/local/bin/docker-compose
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="使用" tabindex="-1"><a class="header-anchor" href="#使用"><span>使用</span></a></h3><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>mkdir composetest
cd composetest
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>composetest/app.py</p><div class="language-ini line-numbers-mode" data-ext="ini" data-title="ini"><pre class="language-ini"><code>import redis
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>composetest/requirements.txt</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>flask
redis
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>Dockerfile</p><div class="language-ini line-numbers-mode" data-ext="ini" data-title="ini"><pre class="language-ini"><code>FROM python:3.7-alpine
WORKDIR /code
...
COPY . .
CMD [&quot;flask&quot;, &quot;run&quot;]
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>docker-compose.yml</p><div class="language-yaml line-numbers-mode" data-ext="yml" data-title="yml"><pre class="language-yaml"><code><span class="token comment"># yaml 配置</span>
<span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">&#39;3&#39;</span>
<span class="token key atrule">services</span><span class="token punctuation">:</span>
  <span class="token key atrule">web</span><span class="token punctuation">:</span>
    <span class="token key atrule">build</span><span class="token punctuation">:</span> .
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用 Compose 命令构建和运行您的应用</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker-compose</span> up <span class="token parameter variable">-d</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="n、docker-私有仓库" tabindex="-1"><a class="header-anchor" href="#n、docker-私有仓库"><span>N、docker 私有仓库</span></a></h2><p>Docker私有仓库主要是企业内部用来存放镜像的仓库，相对官方仓库以及阿里云仓库，具有更高的保密安全级别；</p><h3 id="a-搭建仓库" tabindex="-1"><a class="header-anchor" href="#a-搭建仓库"><span>A 搭建仓库</span></a></h3><h4 id="第一步-拉取私有仓库镜像-私有仓库程序本身就是一个镜像" tabindex="-1"><a class="header-anchor" href="#第一步-拉取私有仓库镜像-私有仓库程序本身就是一个镜像"><span>第一步：拉取私有仓库镜像 （私有仓库程序本身就是一个镜像）</span></a></h4><p>docker pull registry</p><h4 id="第二步-启动私有仓库容器" tabindex="-1"><a class="header-anchor" href="#第二步-启动私有仓库容器"><span>第二步：启动私有仓库容器</span></a></h4><p>docker run -d -v /opt/registry:/var/lib/registry --name=myRegistry -p 5000:5000 registry</p><p>docker run -d -v /opt/registry:/var/lib/registry --name=myRegistry -p 5000:5000 --restart=always registry</p><h4 id="第三步-测试" tabindex="-1"><a class="header-anchor" href="#第三步-测试"><span>第三步：测试</span></a></h4>`,98),W={href:"http://localhost:5000/v2/_catalog",target:"_blank",rel:"noopener noreferrer"},Z=i('<figure><img src="'+k+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>看到这个 说明启动OK。因为仓库里还没有镜像，所以就是空的；</p><h4 id="第四步-etc-docker-修改daemon-json-让docker信任私有仓库地址" tabindex="-1"><a class="header-anchor" href="#第四步-etc-docker-修改daemon-json-让docker信任私有仓库地址"><span>第四步：etc/docker 修改daemon.json，让docker信任私有仓库地址</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="第五步-修改配置后重启docker" tabindex="-1"><a class="header-anchor" href="#第五步-修改配置后重启docker"><span>第五步：修改配置后重启docker</span></a></h4><p>systemctl restart docker</p><h3 id="b-添加镜像到仓库" tabindex="-1"><a class="header-anchor" href="#b-添加镜像到仓库"><span>B 添加镜像到仓库</span></a></h3><h4 id="第一步-标记此镜像为私有仓库的镜像" tabindex="-1"><a class="header-anchor" href="#第一步-标记此镜像为私有仓库的镜像"><span>第一步：标记此镜像为私有仓库的镜像</span></a></h4><p>docker tag nginx:stable-perl localhost:5000/nginx:1.0</p><h4 id="第二步-上传镜像到私有仓库" tabindex="-1"><a class="header-anchor" href="#第二步-上传镜像到私有仓库"><span>第二步：上传镜像到私有仓库</span></a></h4><p>docker push localhost:5000/nginx:1.0</p><figure><img src="`+b+'" alt="image-20210716175146294" tabindex="0" loading="lazy"><figcaption>image-20210716175146294</figcaption></figure><p>此时私有仓库里已经有了这个镜像；</p><h4 id="第三步-删除localhost-5000-nginx本地仓库镜像" tabindex="-1"><a class="header-anchor" href="#第三步-删除localhost-5000-nginx本地仓库镜像"><span>第三步：删除localhost:5000/nginx本地仓库镜像</span></a></h4><p>dkrmi localhost:5000/nginx:1.0</p><h4 id="第四步-从私有仓库拉取localhost-5000-nginx镜像-并运行" tabindex="-1"><a class="header-anchor" href="#第四步-从私有仓库拉取localhost-5000-nginx镜像-并运行"><span>第四步：从私有仓库拉取localhost:5000/nginx镜像，并运行</span></a></h4><p>docker pull localhost:5000/nginx:1.0</p><p>docker run -it -p 80:80 localhost:5000/nginx:1.0</p>',18),Q={id:"第五步-浏览器运行-http-localhost-8080测试",tabindex:"-1"},ss={class:"header-anchor",href:"#第五步-浏览器运行-http-localhost-8080测试"},ns={href:"http://localhost:8080",target:"_blank",rel:"noopener noreferrer"},as=s("figure",null,[s("img",{src:h,alt:"image-20210716175240487",tabindex:"0",loading:"lazy"}),s("figcaption",null,"image-20210716175240487")],-1),es=s("h3",{id:"c-搭建管理界面-harbor-2-2-x",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#c-搭建管理界面-harbor-2-2-x"},[s("span",null,"C 搭建管理界面 harbor-2.2.x")])],-1),is={href:"https://github.com/goharbor/harbor/releases",target:"_blank",rel:"noopener noreferrer"},ts=s("h4",{id:"设置本地域名-etc-hosts",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#设置本地域名-etc-hosts"},[s("span",null,"设置本地域名/etc/hosts")])],-1),ls={href:"http://dk.harbor.com",target:"_blank",rel:"noopener noreferrer"},os=s("br",null,null,-1),cs=i(`<h4 id="生成证书颁发机构证书" tabindex="-1"><a class="header-anchor" href="#生成证书颁发机构证书"><span>生成证书颁发机构证书</span></a></h4><h5 id="生成-ca-证书私钥" tabindex="-1"><a class="header-anchor" href="#生成-ca-证书私钥"><span>---生成 CA 证书私钥</span></a></h5><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>openssl genrsa <span class="token parameter variable">-out</span> ca.key <span class="token number">4096</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h5 id="生成-ca-证书" tabindex="-1"><a class="header-anchor" href="#生成-ca-证书"><span>---生成 CA 证书</span></a></h5><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>openssl req <span class="token parameter variable">-x509</span> <span class="token parameter variable">-new</span> <span class="token parameter variable">-nodes</span> <span class="token parameter variable">-sha512</span> <span class="token parameter variable">-days</span> <span class="token number">3650</span> <span class="token punctuation">\\</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="生成服务器证书" tabindex="-1"><a class="header-anchor" href="#生成服务器证书"><span>生成服务器证书</span></a></h4><h5 id="生成私钥" tabindex="-1"><a class="header-anchor" href="#生成私钥"><span>---生成私钥</span></a></h5><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>openssl genrsa <span class="token parameter variable">-out</span> dkharbor.qyk8.top.key <span class="token number">4096</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h5 id="生成证书签名请求-csr" tabindex="-1"><a class="header-anchor" href="#生成证书签名请求-csr"><span>---生成证书签名请求 (CSR)</span></a></h5><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>openssl req <span class="token parameter variable">-sha512</span> <span class="token parameter variable">-new</span> <span class="token punctuation">\\</span>
    <span class="token parameter variable">-subj</span> <span class="token string">&quot;/C=CN/ST=Beijing/L=Beijing/O=example/OU=Personal/CN=dkharbor.qyk8.top&quot;</span> <span class="token punctuation">\\</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="生成-x509-v3-扩展文件" tabindex="-1"><a class="header-anchor" href="#生成-x509-v3-扩展文件"><span>---生成 x509 v3 扩展文件</span></a></h5><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">cat</span> <span class="token operator">&gt;</span> v3.ext <span class="token operator">&lt;&lt;-</span><span class="token string">EOF
...
DNS.3=k
EOF</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="使用-v3-ext文件为您的-harbor-主机生成证书" tabindex="-1"><a class="header-anchor" href="#使用-v3-ext文件为您的-harbor-主机生成证书"><span>---使用 <code>v3.ext</code>文件为您的 Harbor 主机生成证书</span></a></h5><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>openssl x509 <span class="token parameter variable">-req</span> <span class="token parameter variable">-sha512</span> <span class="token parameter variable">-days</span> <span class="token number">3650</span> <span class="token punctuation">\\</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="向-harbor-和-docker-提供证书" tabindex="-1"><a class="header-anchor" href="#向-harbor-和-docker-提供证书"><span>向 Harbor 和 Docker 提供证书</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">cp</span> dkharbor.qyk8.top.crt ./data/cert/
<span class="token function">cp</span> dkharbor.qyk8.top.key ./data/cert/
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>2,兑换 <code>yourdomain.com.crt</code>至 <code>yourdomain.com.cert</code>，供 Docker 使用。</p><p>Docker 守护进程解释 <code>.crt</code>文件作为 CA 证书和 <code>.cert</code>文件作为客户端证书。</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>openssl x509 <span class="token parameter variable">-inform</span> PEM <span class="token parameter variable">-in</span> dkharbor.qyk8.top.crt <span class="token parameter variable">-out</span> dkharbor.qyk8.top.cert
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>3,将服务器证书、密钥和 CA 文件复制到 Harbor 主机上的 Docker 证书文件夹中。 您必须先创建适当的文件夹。</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">cp</span> dkharbor.qyk8.top.cert /etc/docker/certs.d/dkharbor.qyk8.top/
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果您映射默认 <code>nginx</code>端口 443 到不同的端口，创建文件夹 <code>/etc/docker/certs.d/yourdomain.com:port</code>， 或者 <code>/etc/docker/certs.d/harbor_IP:port</code>.</p><p>4,重启 Docker 引擎。</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>systemctl restart <span class="token function">docker</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="启动" tabindex="-1"><a class="header-anchor" href="#启动"><span>启动</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">#区别，前者会remove掉容器、image、网络，停的更干净，后者只是停服务</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="https访问" tabindex="-1"><a class="header-anchor" href="#https访问"><span>HTTPS访问</span></a></h4>`,27),rs=s("code",null,"/etc/docker/daemon.json",-1),ds=s("code",null,"-insecure-registry",-1),ps={href:"https://yourdomain.com",target:"_blank",rel:"noopener noreferrer"},us=i(`<p>从 Docker 客户端登录 Harbor。</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">docker</span> login yourdomain.com
<span class="token function">docker</span> login yourdomain.com:port
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,2),vs={href:"https://dkharbor.qyk8.top/",target:"_blank",rel:"noopener noreferrer"},ms=i('<h4 id="上传实例" tabindex="-1"><a class="header-anchor" href="#上传实例"><span>上传实例</span></a></h4><h5 id="新建项目" tabindex="-1"><a class="header-anchor" href="#新建项目"><span>-- 新建项目</span></a></h5><figure><img src="'+g+'" alt="image-20210716221821041" tabindex="0" loading="lazy"><figcaption>image-20210716221821041</figcaption></figure><h5 id="推送" tabindex="-1"><a class="header-anchor" href="#推送"><span>-- 推送</span></a></h5><p>dktag b84b6fdf2183 dkharbor.qyk8.top/test/nginx:1.0.1</p><p>dkpush dkharbor.qyk8.top/test/nginx:1.0.1</p><figure><img src="'+f+'" alt="image-20210716221950684" tabindex="0" loading="lazy"><figcaption>image-20210716221950684</figcaption></figure><figure><img src="'+x+'" alt="image-20210716222615232" tabindex="0" loading="lazy"><figcaption>image-20210716222615232</figcaption></figure>',8);function ks(bs,hs){const a=l("ExternalLinkIcon");return o(),c("div",null,[y,s("table",null,[q,s("tbody",null,[E,A,s("tr",null,[R,s("td",O,[n("Docker 客户端通过命令行或者其他工具使用 Docker SDK ("),s("a",I,[n("https://docs.docker.com/develop/sdk/"),e(a)]),n(") 与 Docker 的守护进程通信。")])]),D,N,T])]),j,C,s("p",null,[n("请确保您 "),s("a",M,[n("满足先决条件"),e(a)]),n("，然后 "),s("a",S,[n("安装Docker"),e(a)]),n("。")]),s("p",null,[n("安装 "),s("a",P,[n("window"),e(a)]),n("、"),s("a",w,[n("linux"),e(a)]),n(" 桌面版")]),$,s("p",null,[s("a",F,[n("华为加速"),e(a)])]),s("p",null,[s("a",V,[n("阿里云镜像"),e(a)])]),L,s("p",null,[n("可以在这里查看镜像： "),s("a",U,[n("https://hub.docker.com/_/centos?tab=tags&page=1"),e(a)])]),G,s("p",null,[s("a",B,[n("https://hub.docker.com/"),e(a)]),n(" 注册得到docker id和密码,用docker login登陆hub服务器,docker push推送")]),s("p",null,[n("查看: 登陆 "),s("a",H,[n("https://hub.docker.com/"),e(a)]),n(" 点击 Repositories 菜单")]),z,s("h5",J,[s("a",X,[s("span",null,[n("a, "),s("a",Y,[n("阿里开通镜像服务"),e(a)])])])]),K,s("p",null,[s("a",W,[n("http://localhost:5000/v2/_catalog"),e(a)])]),Z,s("h4",Q,[s("a",ss,[s("span",null,[n("第五步：浏览器运行 "),s("a",ns,[n("http://localhost:8080"),e(a)]),n("测试")])])]),as,es,s("p",null,[s("a",is,[n("下载地址"),e(a)])]),ts,s("p",null,[n("192.168.101.6 "),s("a",ls,[n("dk.harbor.com"),e(a)]),os,n(" 192.168.101.6 dkharbor.qyk8.top")]),cs,s("p",null,[n("某些浏览器可能会显示一条警告，指出证书颁发机检查 "),rs,n("文件以确保 "),ds,n("未为 设置选项 "),s("a",ps,[n("https://yourdomain.com"),e(a)]),n("。")]),us,s("p",null,[n("帐号密码为 admin/Harbor12345 ("),s("a",vs,[n("https://dkharbor.qyk8.top/"),e(a)]),n(")")]),ms])}const xs=t(_,[["render",ks],["__file","docker-note.html.vue"]]);export{xs as default};
