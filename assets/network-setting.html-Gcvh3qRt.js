import{_ as s}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as n,a as e}from"./app-JabzxadU.js";const t={},l=e(`<h1 id="centos网络网卡配置" tabindex="-1"><a class="header-anchor" href="#centos网络网卡配置"><span>centos网络网卡配置</span></a></h1><h2 id="一、设置本机静态ip" tabindex="-1"><a class="header-anchor" href="#一、设置本机静态ip"><span>一、设置本机静态IP</span></a></h2><h3 id="_1、查看本机ip-ifconfig" tabindex="-1"><a class="header-anchor" href="#_1、查看本机ip-ifconfig"><span>1、查看本机ip：ifconfig</span></a></h3><h3 id="_2、设置静态ip-配置文件" tabindex="-1"><a class="header-anchor" href="#_2、设置静态ip-配置文件"><span>2、设置静态ip -&gt; 配置文件</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">#网卡的目录:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3、配置-vim-etc-hosts-映射关系" tabindex="-1"><a class="header-anchor" href="#_3、配置-vim-etc-hosts-映射关系"><span>3、配置 vim /etc/hosts 映射关系</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>//添加ip+主机名
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4、重新启动网络服务" tabindex="-1"><a class="header-anchor" href="#_4、重新启动网络服务"><span>4、重新启动网络服务</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>//网络命令
system network start //启动网络服务
system network stop //停止网络服务
system network restart  //重启网络服务
system network status   //查看网络服务状态
systemctl restart network.service //重启网络服务，
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>system与systemctl的区别：</strong><br> system：centos6之前使用<br> systemctl：centos7之后出现的，centos7也可以使用system，兼容低版本</p><h3 id="_5、ip配置成功" tabindex="-1"><a class="header-anchor" href="#_5、ip配置成功"><span>5、ip配置成功</span></a></h3><h3 id="_6、ping-ctrl-z-退出" tabindex="-1"><a class="header-anchor" href="#_6、ping-ctrl-z-退出"><span>6、ping：ctrl+z 退出</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">ping</span> 语法
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="二、wind映射linux主机" tabindex="-1"><a class="header-anchor" href="#二、wind映射linux主机"><span>二、wind映射Linux主机</span></a></h2><p><code>C:\\Windows\\System32\\drivers\\etc</code></p>`,23),i=[l];function o(p,r){return a(),n("div",null,i)}const v=s(t,[["render",o],["__file","network-setting.html.vue"]]);export{v as default};
