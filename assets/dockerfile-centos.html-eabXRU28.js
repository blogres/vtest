import{_ as a}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as n,a as e}from"./app-JabzxadU.js";const l={},p=e(`<h1 id="dockerfile-配置基于centos7-安装运行jdk、java项目jar包、并设置中文utf-8字符集" tabindex="-1"><a class="header-anchor" href="#dockerfile-配置基于centos7-安装运行jdk、java项目jar包、并设置中文utf-8字符集"><span>DockerFile 配置基于centos7 安装运行jdk、Java项目jar包、并设置中文UTF-8字符集</span></a></h1><h2 id="dockerfile脚本" tabindex="-1"><a class="header-anchor" href="#dockerfile脚本"><span>dockerfile脚本</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>FROM registry.cn-chengdu.aliyuncs.com/jinfang/centos:7.9
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),i=[p];function t(o,c){return s(),n("div",null,i)}const d=a(l,[["render",t],["__file","dockerfile-centos.html.vue"]]);export{d as default};
