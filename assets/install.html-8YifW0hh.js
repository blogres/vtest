import{_ as t}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as i,o,c as r,b as s,e as n,d as l,a}from"./app-JabzxadU.js";const c={},p=a(`<h1 id="linux下安装mysql" tabindex="-1"><a class="header-anchor" href="#linux下安装mysql"><span>Linux下安装mysql</span></a></h1><h2 id="rpm-方式安装-mysql" tabindex="-1"><a class="header-anchor" href="#rpm-方式安装-mysql"><span>rpm 方式安装 mysql</span></a></h2><h3 id="_1、检查当前操作系统是否安装过mysql-如果安装进行卸载操作" tabindex="-1"><a class="header-anchor" href="#_1、检查当前操作系统是否安装过mysql-如果安装进行卸载操作"><span>1、检查当前操作系统是否安装过mysql ，如果安装进行卸载操作</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">#查看是否安装有mysql</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2、下载与安装mysql" tabindex="-1"><a class="header-anchor" href="#_2、下载与安装mysql"><span>2、下载与安装mysql</span></a></h3><p>要求在线下载安装，所以必须保证你的虚拟机的Linux系统能正常的访问外网( 上网)</p><p>注：如何系统中没安装wget软件, 先安装:</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>yum –y <span class="token function">install</span> <span class="token function">wget</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="使用-wget-命令下载mysql的repo源" tabindex="-1"><a class="header-anchor" href="#使用-wget-命令下载mysql的repo源"><span>使用 wget 命令下载mysql的repo源</span></a></h4><hr>`,10),d={href:"https://downloads.mysql.com/archives/community/",target:"_blank",rel:"noopener noreferrer"},m=a(`<div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>wget https://cdn.mysql.com//Downloads/MySQL-5.7/mysql-community-common-5.7.38-1.el7.x86_64.rpm
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">wget</span> http://repo.mysql.com/mysql57-community-release-el7-11.noarch.rpm
<span class="token function">chmod</span> +x mysql*
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="使用-rpm-安装mysql-的yum源" tabindex="-1"><a class="header-anchor" href="#使用-rpm-安装mysql-的yum源"><span>使用 rpm 安装mysql 的yum源</span></a></h4><ul><li>安装时必须严格遵守安装顺序 <strong>依赖关系依次为 common → libs → client → server</strong></li><li><strong>注</strong>：ivh中， i-install安装；v-verbose进度条；h-hash哈希校验</li></ul><p><strong>方式一：</strong><code>yum -y install ./mysql57-community-release-el7-11.noarch.rpm</code></p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@admin soft<span class="token punctuation">]</span><span class="token comment"># yum -y install ./mysql57-community-release-el7-11.noarch.rpm</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>方式二：</strong><code>rpm -ivh ./mysql57-community-release-el7-11.noarch.rpm</code></p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@admin soft<span class="token punctuation">]</span><span class="token comment"># rpm -ivh ./mysql57-community-release-el7-11.noarch.rpm</span>
<span class="token comment">#查看</span>
<span class="token punctuation">[</span>root@admin soft<span class="token punctuation">]</span><span class="token comment"># rpm -aq | grep mysql</span>
mysql57-community-release-el7-11.noarch
<span class="token punctuation">[</span>root@admin soft<span class="token punctuation">]</span><span class="token comment"># yum repolist enabled | grep mysql.*</span>
...
mysql-tools-community/x86_64      MySQL Tools Community                       <span class="token number">92</span>
mysql57-community/x86_64          MySQL <span class="token number">5.7</span> Community Server                 <span class="token number">604</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>yum 源安装mysql服务</li></ul><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@admin soft<span class="token punctuation">]</span><span class="token comment"># yum -y install mysql-community-server</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>方式三：（推荐）</strong></p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">rpm</span> <span class="token parameter variable">-ivh</span> mysql-community-common-5.7.38-1.el7.x86_64.rpm
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>不需要执行：yum -y install mysql-community-server</strong></p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 安装后查询安装的MySQL版本</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h3 id="_3、-启动-mysql-服务" tabindex="-1"><a class="header-anchor" href="#_3、-启动-mysql-服务"><span>3、 启动 mysql 服务</span></a></h3><table><thead><tr><th>CentOS6及以前版本</th><th>CentOS7</th><th>作用</th></tr></thead><tbody><tr><td>service 服务名 start</td><td>systemctl start 服务名</td><td>启动某个服务</td></tr><tr><td>service 服务名 stop</td><td>systemctl stop 服务名</td><td>停止</td></tr><tr><td>service 服务名 restart</td><td>systemctl restart 服务名</td><td>重启</td></tr><tr><td>service 服务名 status</td><td>systemctl status 服务名</td><td>查看状态</td></tr><tr><td></td><td>systemctl enable 服务名</td><td>服务永久生效</td></tr><tr><td></td><td>systemctl disable 服务名</td><td>服务永久关闭</td></tr></tbody></table><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">#当前有效，关机后失效</span>
systemctl start mysqld
systemctl status mysqld
<span class="token comment">#启用系统服务永久生效</span>
systemctl <span class="token builtin class-name">enable</span> mysqld
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-、配置mysql" tabindex="-1"><a class="header-anchor" href="#_4-、配置mysql"><span>4 、配置mysql</span></a></h3><h4 id="查看密码" tabindex="-1"><a class="header-anchor" href="#查看密码"><span>查看密码</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">cat</span> /var/log/mysqld.log <span class="token operator">|</span> <span class="token function">grep</span> password
或者：
<span class="token function">grep</span> <span class="token string">&#39;temporary password&#39;</span> /var/log/mysqld.log
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="登陆mysql" tabindex="-1"><a class="header-anchor" href="#登陆mysql"><span>登陆mysql</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>mysql  <span class="token parameter variable">-uroot</span> <span class="token parameter variable">-p</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="进入mysql系统数据库" tabindex="-1"><a class="header-anchor" href="#进入mysql系统数据库"><span>进入mysql系统数据库</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>use mysql<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>在执行此语句之前，必须使用ALTER USER语句重置密码</p><blockquote><p>You must reset your password using ALTER USER statement before executing this statement.</p></blockquote><h4 id="设置密码" tabindex="-1"><a class="header-anchor" href="#设置密码"><span>设置密码</span></a></h4><p><strong>判断修改密码时候新密码是否符合当前的策略，密码不满足会报错，不让修改。</strong></p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token builtin class-name">set</span> global <span class="token assign-left variable">validate_password_policy</span><span class="token operator">=</span><span class="token number">0</span><span class="token punctuation">;</span> 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>（选1种即可：）</p><p><strong>（1）</strong> ALTER USER &#39;root&#39;@&#39;localhost&#39; IDENTIFIED BY &#39;root12&#39;;</p><p><strong>（2）</strong> update user set password=password(&#39;root12&#39;) where user=&#39;root&#39;;</p><p><strong>刷新：</strong> flush privileges;</p><p>如果出现【ERROR1054(42S22):Unknown column &#39;password&#39; in &#39;field list&#39;】</p><p>执行：<code>update mysql.user set authentication_string=password(&#39;root12&#39;) where user=&#39;root&#39;;</code> 即可</p><h4 id="查看-新密码校验插件-可选项" tabindex="-1"><a class="header-anchor" href="#查看-新密码校验插件-可选项"><span>查看 新密码校验插件（可选项）</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>mysql<span class="token operator">&gt;</span> show variables like <span class="token string">&#39;validate_password%&#39;</span><span class="token punctuation">;</span>
+--------------------------------------+--------+
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="设置访问权限-可以通过外部连接-数据库" tabindex="-1"><a class="header-anchor" href="#设置访问权限-可以通过外部连接-数据库"><span>设置访问权限,可以通过外部连接 数据库</span></a></h4><p>GRANT ALL PRIVILEGES ON *.* TO [远程访问用户名]@&#39;IP&#39; IDENTIFIED BY [&#39;密码&#39;] WITH GRANT OPTION;</p><p>如：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>GRANT ALL PRIVILEGES ON *.* TO &#39;root&#39;@&#39;%&#39;IDENTIFIED BY &#39;root12&#39; WITH GRANT OPTION;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="开启log-bin日志" tabindex="-1"><a class="header-anchor" href="#开启log-bin日志"><span>开启log-bin日志</span></a></h4><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>set global log_bin_trust_function_creators=1;

持久化对应my.cnf
log_bin_trust_function_creators=1
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>刷新马上生效</strong></p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>flush privileges<span class="token punctuation">;</span>
<span class="token builtin class-name">exit</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>重启mysql服务</strong></p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>systemctl  restart  mysqld
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>查看进程</strong></p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">ps</span> <span class="token parameter variable">-e</span> <span class="token operator">|</span> <span class="token function">grep</span> mysqld
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_5、开放端口" tabindex="-1"><a class="header-anchor" href="#_5、开放端口"><span>5、开放端口</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>实际应用场景中防火墙是要打开的，只能开放端口来外部访问。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>permanent
重启防火墙：systemctl restart firewalld
命令含义：
--zone #作用域
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6、自己配置文件-vim-etc-my-cnf" tabindex="-1"><a class="header-anchor" href="#_6、自己配置文件-vim-etc-my-cnf"><span>6、自己配置文件 vim /etc/my.cnf</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># For advice on how to change settings please see</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>systemctl restart mysqld</p><h2 id="tar-方式安装" tabindex="-1"><a class="header-anchor" href="#tar-方式安装"><span>tar 方式安装</span></a></h2>`,58),u={href:"https://cdn.mysql.com//Downloads/MySQL-5.7/mysql-5.7.38-el7-x86_64.tar.gz",target:"_blank",rel:"noopener noreferrer"},v=a(`<h3 id="解压" tabindex="-1"><a class="header-anchor" href="#解压"><span>解压</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">#授权</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2);function b(h,k){const e=i("ExternalLinkIcon");return o(),r("div",null,[p,s("p",null,[s("a",d,[n("https://downloads.mysql.com/archives/community/"),l(e)]),n("：下载【common、libs、client、server】这几个文件")]),m,s("p",null,[n("wget "),s("a",u,[n("https://cdn.mysql.com//Downloads/MySQL-5.7/mysql-5.7.38-el7-x86_64.tar.gz"),l(e)])]),v])}const _=t(c,[["render",b],["__file","install.html.vue"]]);export{_ as default};
