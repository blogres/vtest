...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,29);function f(q,y){const e=p("ExternalLinkIcon");return t(),c("div",null,[r,s("p",null,[n("部分内容来自："),s("a",d,[n("CSDN ，作者：鮀城小帅"),l(e)])]),u,s("p",null,[n("完整的 "),s("a",v,[n("delete-user.sh"),l(e)]),n(" 脚本")]),m,k,b,s("p",null,[s("a",h,[n("while.sh"),l(e)])]),g])}const E=i(o,[["render",f],["__file","shell4.html.vue"]]);export{E as default};
