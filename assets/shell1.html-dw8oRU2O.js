import{_ as l}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as t,o as i,c as p,b as n,e as s,d as e,a as o}from"./app-JabzxadU.js";const c="/vtest/assets/true-image-20220914104641154-trMXeABS.png",r="/vtest/assets/true-image-20220914105143147-ZxT6C_uV.png",u="/vtest/assets/true-image-20220914105525933-ck26wAnz.png",d="/vtest/assets/true-image-20220914120636967-GgE3QtB4.png",m={},v=n("p",null,"Linux之shell脚本的一些基础知识认识",-1),b=n("h1",{id:"基础认识",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#基础认识"},[n("span",null,"基础认识")])],-1),k=n("h2",{id:"终端仿真器",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#终端仿真器"},[n("span",null,"终端仿真器")])],-1),h={href:"https://help.gnome.org/users/gnome-terminal/stable",target:"_blank",rel:"noopener noreferrer"},g={href:"http://konsole.kde.org",target:"_blank",rel:"noopener noreferrer"},f={href:"http://www.eterm.org",target:"_blank",rel:"noopener noreferrer"},_={href:"http://finalterm.org",target:"_blank",rel:"noopener noreferrer"},x={href:"https://github.com/Guake/guake",target:"_blank",rel:"noopener noreferrer"},E={href:"http://lilyterm.luna.com.tw/index.html",target:"_blank",rel:"noopener noreferrer"},I={href:"http://wiki.lxde.org/en/LXTerminal",target:"_blank",rel:"noopener noreferrer"},S={href:"https://code.google.com/p/mrxvt",target:"_blank",rel:"noopener noreferrer"},T={href:"http://roxterm.sourceforge.net",target:"_blank",rel:"noopener noreferrer"},H={href:"https://launchpad.net/terminator",target:"_blank",rel:"noopener noreferrer"},M={href:"http://www.enlightenment.org/p.php?p=about/terminology",target:"_blank",rel:"noopener noreferrer"},O={href:"http://manpages.ubuntu.com/manpages/gutsy/man1/uxterm.1.html",target:"_blank",rel:"noopener noreferrer"},P={href:"http://sourceforge.net/projects/wterm",target:"_blank",rel:"noopener noreferrer"},C={href:"http://invisible-island.net/xterm",target:"_blank",rel:"noopener noreferrer"},D=o(`<h2 id="shell-类型" tabindex="-1"><a class="header-anchor" href="#shell-类型"><span>shell 类型</span></a></h2><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>/bin/bash /bin/sh  /bin/tcsh
/bin/dash /bin/csh
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>输入命令 bash 之后，一个子shell就出现了。第二个 ps -f 是在子shell中执行的。可以从显示结果中看到有两个bash shell程序在运行。第一个bash shell程序，也就是父shell进程，其原始进程ID是 <em>1490</em> 。第二个bash shell程序，即子shell进程，其PID是 <em>12590</em>。注意，子shell的父进程ID（<code>PPID</code>）是 <em>1490</em> ，指明了这个父shell进程就是该子shell的父进程</p><figure><img src="`+c+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>在生成子shell进程时，只有部分父进程的环境被复制到子shell环境中。这会对包括变量在内的一些东西造成影响。</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@admin ~<span class="token punctuation">]</span><span class="token comment"># ps -f</span>
<span class="token environment constant">UID</span>         PID   <span class="token environment constant">PPID</span>  C STIME TTY          TIME CMD
root       <span class="token number">1490</span>   <span class="token number">1479</span>  <span class="token number">0</span> <span class="token number">10</span>:06 pts/0    00:00:00 <span class="token parameter variable">-bash</span>
root      <span class="token number">12590</span>   <span class="token number">1490</span>  <span class="token number">0</span> <span class="token number">10</span>:33 pts/0    00:00:00 <span class="token function">bash</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当外部命令执行时，会创建出一个子进程。这种操作被称为衍生（forking）。外部命令 ps 很方便显示出它的父进程以及自己所对应的衍生子进程。</p><p>作为外部命令， ps 命令执行时会创建出一个子进程。</p><figure><img src="`+d+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@admin ~<span class="token punctuation">]</span><span class="token comment"># ps -f</span>
<span class="token environment constant">UID</span>         PID   <span class="token environment constant">PPID</span>  C STIME TTY          TIME CMD
root       <span class="token number">1490</span>   <span class="token number">1479</span>  <span class="token number">0</span> <span class="token number">10</span>:06 pts/0    00:00:00 <span class="token parameter variable">-bash</span>
...
mysql:x:27:
user1:x:1001:
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>组名</li><li>组密码</li><li>GID</li><li>属于该组的用户列表</li></ul><p><strong>千万不能通过直接修改/etc/group文件来添加用户到一个组，要用 usermod 命令</strong></p><p>需要参考基础知识：</p>`,159),A={href:"/linux/basis/basis.html#%E7%94%A8%E6%88%B7%E5%8F%8A%E6%9D%83%E9%99%90%E7%AE%A1%E7%90%86",target:"_blank",rel:"noopener noreferrer"},L={href:"/linux/basis/basis.html#%E7%9B%AE%E5%BD%95%E6%96%87%E4%BB%B6%E7%AE%A1%E7%90%86",target:"_blank",rel:"noopener noreferrer"},y={href:"/linux/basis/basis.html#%E7%A3%81%E7%9B%98%E7%AE%A1%E7%90%86",target:"_blank",rel:"noopener noreferrer"},w=n("li",null,"等等",-1);function B(N,$){const a=t("ExternalLinkIcon");return i(),p("div",null,[v,b,k,n("p",null,[s("GNOME Terminal（一般系统默认） "),n("a",h,[s("https://help.gnome.org/users/gnome-terminal/stable"),e(a)])]),n("p",null,[s("Konsole Terminal "),n("a",g,[s("http://konsole.kde.org"),e(a)])]),n("p",null,[s("Eterm "),n("a",f,[s("http://www.eterm.org"),e(a)])]),n("p",null,[s("Final Term "),n("a",_,[s("http://finalterm.org"),e(a)])]),n("p",null,[s("Guake "),n("a",x,[s("https://github.com/Guake/guake"),e(a)])]),n("p",null,[s("LillyTerm "),n("a",E,[s("http://lilyterm.luna.com.tw/index.html"),e(a)])]),n("p",null,[s("LXTerminal "),n("a",I,[s("http://wiki.lxde.org/en/LXTerminal"),e(a)])]),n("p",null,[s("mrxvt "),n("a",S,[s("https://code.google.com/p/mrxvt"),e(a)])]),n("p",null,[s("ROXTerm "),n("a",T,[s("http://roxterm.sourceforge.net"),e(a)])]),n("p",null,[s("Terminator "),n("a",H,[s("https://launchpad.net/terminator"),e(a)])]),n("p",null,[s("Terminology "),n("a",M,[s("http://www.enlightenment.org/p.php?p=about/terminology"),e(a)])]),n("p",null,[s("UXterm "),n("a",O,[s("http://manpages.ubuntu.com/manpages/gutsy/man1/uxterm.1.html"),e(a)])]),n("p",null,[s("Wterm "),n("a",P,[s("http://sourceforge.net/projects/wterm"),e(a)])]),n("p",null,[s("xterm "),n("a",C,[s("http://invisible-island.net/xterm"),e(a)])]),D,n("ul",null,[n("li",null,[n("a",A,[s("参考：用户及权限管理"),e(a)])]),n("li",null,[n("a",L,[s("参考：目录文件管理"),e(a)])]),n("li",null,[n("a",y,[s("参考：磁盘管理"),e(a)])]),w])])}const G=l(m,[["render",B],["__file","shell1.html.vue"]]);export{G as default};
