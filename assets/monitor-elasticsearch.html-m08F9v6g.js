...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,10),h={href:"http://cpufreedisk.sh",target:"_blank",rel:"noopener noreferrer"},g=s("code",null,"ElasticSearch",-1),f=s("em",null,"/usr/local/jiaoben/",-1),q=t(`<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,6);function y(x,_){const a=i("ExternalLinkIcon");return o(),p("div",null,[r,s("p",null,[s("a",d,[n("以下文章来自公众号：杰哥的IT之旅 ，作者JackTian"),e(a)])]),u,s("h3",v,[s("a",k,[s("span",null,[s("a",m,[n("mianmiyao.sh"),e(a)]),n(" 脚本文件内容")])])]),b,s("p",null,[n("将 "),s("em",null,[s("a",h,[n("cpufreedisk.sh"),e(a)])]),n(" 脚本文件放入 "),g,n(" 服务器的 "),f,n(" 目录下")]),q])}const w=l(c,[["render",y],["__file","monitor-elasticsearch.html.vue"]]);export{w as default};
