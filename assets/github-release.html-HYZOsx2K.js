...
pnpm run commit
pnpm run release
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在这里选择patch (1.0.1)，一路默认回车。</p>`,27);function C(L,H){const e=l("ExternalLinkIcon");return o(),c("div",null,[r,n("p",null,[n("a",p,[s("项目源码"),a(e)])]),u,n("ul",null,[v,m,n("li",null,[s("执行 sh "),n("a",b,[s("commit.sh"),a(e)]),s(" | pnpm run commit 设置提交消息")])]),g,n("p",null,[s("上面介绍的适配器，只是其中一种，社区还提供了很多其它的适配器，可以去 "),n("a",h,[s("项目页面"),a(e)]),s(" 查看。")]),k,n("p",null,[n("a",q,[s("github地址"),a(e)])]),f,n("p",null,[s("配置 "),n("a",x,[s(".commitlintrc.js 查看支持文件类型"),a(e)])]),_,n("blockquote",null,[y,n("p",null,[z,s(" 表示从 "),n("a",A,[s("CHANGELOG.md"),a(e)]),s(" 读取 changelog")]),j]),G,n("p",null,[n("a",N,[s("github仓库"),a(e)])]),E])}const $=t(d,[["render",C],["__file","github-release.html.vue"]]);export{$ as default};
