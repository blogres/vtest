import{_ as e}from"./true-image-20220913170020223-RtJXjMeo.js";import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as a,o as l,c as d,b as n,d as o,w as c,a as r,e as t}from"./app-JabzxadU.js";const v={},u=n("h3",{id:"sort-排序数据",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#sort-排序数据"},[n("span",null,"sort 排序数据")])],-1),m=r('<p>①、命令名称：sort</p><p>②、英文原意：</p><p>③、命令所在路径：</p><p>④、执行权限：所有用户</p><p>⑤、功能描述：对数据进行排序</p><p>⑥、语法：</p><p>cat 【选项】 【文件】</p><figure><img src="'+e+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@admin home<span class="token punctuation">]</span><span class="token comment"># cat demo.txt</span>
one
two
three
four
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,14);function p(b,k){const s=a("RouterLink");return l(),d("div",null,[u,n("ul",null,[n("li",null,[o(s,{to:"/linux/basis/command.html#%E6%96%87%E6%A1%A3%E7%BC%96%E8%BE%91"},{default:c(()=>[t("返回命令大全列表")]),_:1})])]),m])}const x=i(v,[["render",p],["__file","sort.html.vue"]]);export{x as default};
